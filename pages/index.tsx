...
export default function Home(props) {
  ...
  return (
    <div className="">
      <Head>
        <title>Pizza_Park.Pizza | Get Tipped In Crypto</title>
        <meta name="title" content="Pizza_Park.Pizza | Get Tipped In Crypto" />
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Pizza_Park.Pizza | Get Tipped In Crypto"
        />
        <meta
        ...
        <section className="px-3 md:px-20">
          <div>
            ...
            <div className="mx-2 text-center py-4 rounded-full bg-white dark:bg-zinc-800  mb-4 text-lg lg:max-w-lg lg:mx-auto">
              <span className="">Pizza_Park.pizza/</span>
              <input
                type={"text"}
        ...
        <section className="bg-yellow-50 pb-10 rounded-3xl dark:bg-yellow-300">
          <div className="px-3 md:px-20">
            ...
            <p className="pt-8 px-2 py-4 text-center text-gray-800 font-Montserrat font-bold leading-7 text-lg">
              Pizza_Park.Pizza makes supporting pretty awesome. With just a
              click, your followers can tip you enough crypto to get yourself a
