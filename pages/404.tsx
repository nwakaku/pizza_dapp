...
export default function Custom404() {
  return (
    <>
      <Head>
        <title>Pizza_Park.Pizza | 404</title>
        <meta name="title" content="Pizza_Park.Pizza | 404" />
        <meta
          name="description"
        ...
        <meta property="og:title" content="Pizza_Park.Pizza | 404" />
        <meta
        ...
        <meta property="twitter:title" content="Pizza_Park.Pizza | 404" />
        <meta
