  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.Pizza_Park.pizza/${post.slug}`}
        />
        <meta
          property="og:title"
          content={`${post.title} | @${post.username}`}
        />
        <meta
          property="og:description"
          content={post.context.substring(0, 159)}
        />
        <meta
          property="og:image"
          ...
          <section className="md:max-w-3xl md:mx-auto">
            ...
            <div className="-mt-10 text-right mr-4">
              <AuthCheck
                fallback={
                  <Link href="/enter">
                    <button className="mr-6 text-sm font-CircularMedium bg-yellow-300 rounded-full py-1 w-24 text-center disabled:bg-gray-200 md:max-w-xs md:mx-auto hover:scale-105 transition-all dark:text-black">
                      🍕 Sign Up
                    </button>
                  </Link>
                }
